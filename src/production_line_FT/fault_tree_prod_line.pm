...
module or_gate1
    ...
    [] (a_or1=1) & (or1=2) & (c_or1=0) & (p1=0) & (m1=0) & (t1<6) -> 0.1: (m1'=1) & (t1'=t1+2) & (a_or1'=0) + 0.9: (p1'=1);
    [] (b_or1=1) & (or1=2) & (c_or1=0) & (p1=0) & (m1=0) & (t1<6) -> 0.1: (m1'=1) & (t1'=t1+2) & (b_or1'=0) + 0.9: (p1'=1);

    [] (m1=1) -> (or1'=1) & (a_or1'=0) & (b_or1'=0) & (c_or1'=0) & (m1'=0) & (p1'=0);

    [] (p1=1) & (a_or1=1) & (c_or1=0) & (t1<6) -> (c_or1'=1) & (v1'=1) & (t1'=t1+2);
    [] (p1=1) & (b_or1=1) & (c_or1=0) & (t1<6) -> (c_or1'=1) & (v1'=1) & (t1'=t1+2);
endmodule

module or_gate2
    [] (or2=1) & (a_or2=0) & (b_or2=0) & (c_or2=0) & (m2=0) & (p2=0) -> 0.15: (a_or2'=1) & (or2'=2) + 0.20: (b_or2'=1) & (or2'=2) + 0.65: (or2'=1);
    [] (a_or2=1) & (or2=2) & (c_or2=0) & (p2=0) & (m2=0) & (t2<6) -> 0.1: (m2'=1) & (t2'=t2+1) & (a_or2'=0) + 0.9: (p2'=1);
    [] (b_or2=1) & (or2=2) & (c_or2=0) & (p2=0) & (m2=0) & (t2<6) -> 0.1: (m2'=1) & (t2'=t2+1) & (b_or2'=0) + 0.9: (p2'=1);

    [] (m2=1) -> (or2'=1) & (a_or2'=0) & (b_or2'=0) & (c_or2'=0) & (m2'=0) & (p2'=0);

    [] (p2=1) & (a_or2=1) & (c_or2=0) & (t2<6) -> (c_or2'=1) & (v2'=1) & (t2'=t2+1);
    [] (p2=1) & (b_or2=1) & (c_or2=0) & (t2<6) -> (c_or2'=1) & (v2'=1) & (t2'=t2+1);
endmodule

module or_gate3
    [] (a_or3=1) & (c_or3=0) & (p3=0) & (m3=0) & (v2=1) & (t3<6) -> 0.1: (m3'=1) & (t3'=max(t1,t2)+1) & (a_or3'=0) + 0.9: (p3'=1);
    [] (b_or3=1) & (c_or3=0) & (p3=0) & (m3=0) & (v1=1) & (t3<6) -> 0.1: (m3'=1) & (t3'=max(t1,t2)+1) & (b_or3'=0) + 0.9: (p3'=1);
    ...
    [] (p3=1) & (a_or3=1) & (c_or3=0) & (t3<6) -> (c_or3'=1) & (v3'=1) & (t3'=t3+1);
    [] (p3=1) & (b_or3=1) & (c_or3=0) & (t3<6) -> (c_or3'=1) & (v3'=1) & (t3'=t3+1);
endmodule

module or_gate4
    [] (or4=1) & (a_or4=0) & (b_or4=0) & (c_or4=0) & (m4=0) & (p4=0) -> 0.32: (a_or4'=1) & (or4'=2) + 0.05: (b_or4'=1) & (or4'=2) + 0.63: (or4'=1);
    [] (a_or4=1) & (or4=2) & (c_or4=0) & (p4=0) & (m4=0) & (t4<6) -> 0.1: (m4'=1) & (t4'=t4+2) & (a_or4'=0) + 0.9: (p4'=1);
    [] (b_or4=1) & (or4=2) & (c_or4=0) & (p4=0) & (m4=0) & (t4<6) -> 0.1: (m4'=1) & (t4'=t4+2) & (b_or4'=0) + 0.9: (p4'=1);

    [] (m4=1) -> (or4'=1) & (a_or4'=0) & (b_or4'=0) & (c_or4'=0) & (m4'=0) & (p4'=0);

    [] (p4=1) & (a_or4=1) & (c_or4=0) & (t4<6) -> (c_or4'=1) & (v4'=1) & (t4'=t4+2);
    [] (p4=1) & (b_or4=1) & (c_or4=0) & (t4<6) -> (c_or4'=1) & (v4'=1) & (t4'=t4+2);
endmodule

module or_gate5
    [] (or5=1) & (a_or5=0) & (b_or5=0) & (c_or5=0) & (m5=0) & (p5=0) -> 0.10: (a_or5'=1) & (or5'=2) + 0.05: (b_or5'=1) & (or5'=2) + 0.85: (or5'=1);
    [] (a_or5=1) & (or5=2) & (c_or5=0) & (p5=0) & (m5=0) & (t5<8) -> 0.1: (m5'=1) & (t5'=t5+3) & (a_or5'=0) + 0.9: (p5'=1);
    [] (b_or5=1) & (or5=2) & (c_or5=0) & (p5=0) & (m5=0) & (t5<8) -> 0.1: (m5'=1) & (t5'=t5+3) & (b_or5'=0) + 0.9: (p5'=1);

    [] (m5=1) -> (or5'=1) & (a_or5'=0) & (b_or5'=0) & (c_or5'=0) & (m5'=0) & (p5'=0);

    [] (p5=1) & (a_or5=1) & (c_or5=0) & (t5<8) -> (c_or5'=1) & (v5'=1) & (t5'=t5+3);
    [] (p5=1) & (b_or5=1) & (c_or5=0) & (t5<8) -> (c_or5'=1) & (v5'=1) & (t5'=t5+3);
endmodule

module or_gate6
    [] (a_or6=1) & (c_or6=0) & (p6=0) & (m6=0) & (v5=1) & (t6<12) -> 0.1: (m6'=1) & (t6'=max(t4,t5)+2) & (a_or6'=0) + 0.9: (p6'=1);
    [] (b_or6=1) & (c_or6=0) & (p6=0) & (m6=0) & (v4=1) & (t6<12) -> 0.1: (m6'=1) & (t6'=max(t4,t5)+2) & (b_or6'=0) + 0.9: (p6'=1);
    ...
    [] (p6=1) & (a_or6=1) & (c_or6=0) & (t6<12) -> (c_or6'=1) & (v6'=1) & (t6'=t6+2);
    [] (p6=1) & (b_or6=1) & (c_or6=0) & (t6<12) -> (c_or6'=1) & (v6'=1) & (t6'=t6+2);
endmodule
...
module or_gate7
    ...
    [] (a_or7=1) & (or7=2) & (c_or7=0) & (p7=0) & (m7=0) & (t7<10) -> 0.1: (m7'=1) & (t7'=t3+1) & (a_or7'=0) + 0.9: (p7'=1);
    [] (b_or7=1) & (or7=2) & (c_or7=0) & (p7=0) & (m7=0) & (t7<10) -> 0.1: (m7'=1) & (t7'=t3+1) & (b_or7'=0) + 0.9: (p7'=1);
    ...
    [] (p7=1) & (a_or7=1) & (c_or7=0) & (t7<10) -> (c_or7'=1) & (v7'=1) & (t7'=t7+1);
    [] (p7=1) & (b_or7=1) & (c_or7=0) & (t7<10) -> (c_or7'=1) & (v7'=1) & (t7'=t7+1);
endmodule


module or_gate8
    [] (a_or8=1) & (c_or8=0) & (p8=0) & (m8=0) & (v7=1) & (tf<16) -> 0.1: (m8'=1) & (tf'=max(t6,t7)+2) & (a_or8'=0) + 0.9: (p8'=1);
    [] (b_or8=1) & (c_or8=0) & (p8=0) & (m8=0) & (v6=1) & (tf<16) -> 0.1: (m8'=1) & (tf'=max(t6,t7)+2) & (b_or8'=0) + 0.9: (p8'=1);
    ...
    [] (p8=1) & (a_or8=1) & (c_or8=0) & (tf<16) -> (c_or8'=1) & (v8'=1) & (tf'=tf+2);
    [] (p8=1) & (b_or8=1) & (c_or8=0) & (tf<16) -> (c_or8'=1) & (v8'=1) & (tf'=tf+2);
endmodule
