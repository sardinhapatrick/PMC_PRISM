...
module or_gate3_mask
    [] (a_or3=1) & (c_or3=0) & (p3=0) & (m3=0) & (v2=1) & (t3<max_t3) -> 0.1: (m3'=1) & (t3'=max(t1,t2)+1) & (t1'=t1+2+1) & (t2'=t2+1+1) & (a_or3'=0) + 0.9: (a_or3'=1);
    [] (b_or3=1) & (c_or3=0) & (p3=0) & (m3=0) & (v1=1) & (t3<max_t3) -> 0.1: (m3'=1) & (t3'=max(t1,t2)+1) & (t1'=t1+2+1) & (t2'=t2+1+1) & (b_or3'=0) + 0.9: (b_or3'=1);

    [] (m3=1) -> (v1'=1) & (v2'=1) & (a_or3'=0) & (b_or3'=0) & (c_or3'=0) & (m3'=0) & (p3'=0) & (v3'=0);
endmodule
...
module or_gate6_mask
    [] (a_or6=1) & (c_or6=0) & (p6=0) & (m6=0) & (v5=1) & (t6<max_t6) -> 0.1: (m6'=1) & (t6'=max(t4,t5)+2) & (t4'=t4+2+2) & (t5'=t5+3+2) & (a_or6'=0) + 0.9: (a_or6'=1);
    [] (b_or6=1) & (c_or6=0) & (p6=0) & (m6=0) & (v4=1) & (t6<max_t6) -> 0.1: (m6'=1) & (t6'=max(t4,t5)+2) & (t4'=t4+2+2) & (t5'=t5+3+2) & (b_or6'=0) + 0.9: (b_or6'=1);

    [] (m6=1) -> (v4'=1) & (v5'=1) & (a_or6'=0) & (b_or6'=0) & (c_or6'=0) & (m6'=0) & (p6'=0) & (v6'=0);
endmodule
...
module or_gate7_mask
    ...
    [] (a_or7=1) & (or7=2) & (c_or7=0) & (p7=0) & (m7=0) & (t7<max_t7) -> 0.1: (m7'=1) & (t7'=t3+1) & (t3'=t3*2+1) & (a_or7'=0) + 0.9: (a_or7'=1);
    [] (b_or7=1) & (or7=2) & (c_or7=0) & (p7=0) & (m7=0) & (t7<max_t7) -> 0.1: (m7'=1) & (t7'=t3+1) & (t3'=t3*2+1) & (b_or7'=0) + 0.9: (b_or7'=1);
...
module or_gate8_mask
    [] (a_or8=1) & (c_or8=0) & (p8=0) & (m8=0) & (v7=1) & (tf<max_tf) -> 0.1: (m8'=1) & (tf'=max(t6,t7)+2) & (t6'=t6*2+2) & (t7'=t7*2+2) & (a_or8'=0) + 0.9: (a_or8'=1);
    [] (b_or8=1) & (c_or8=0) & (p8=0) & (m8=0) & (v6=1) & (tf<max_tf) -> 0.1: (m8'=1) & (tf'=max(t6,t7)+2) & (t6'=t6*2+2) & (t7'=t7*2+2) & (b_or8'=0) + 0.9: (b_or8'=1);

    [] (m8=1) -> (v6'=1) & (v7'=1) & (a_or8'=0) & (b_or8'=0) & (c_or8'=0) & (m8'=0) & (p8'=0) & (v8'=0);
endmodule
