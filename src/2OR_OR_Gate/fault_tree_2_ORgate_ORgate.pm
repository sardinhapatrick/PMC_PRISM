...
module or_gate1
    ...
    [] (a_or1=1) & (or1=2) & (c_or1=0) & (p1=0) & (m1=0) -> 0.1: (m1'=1) & (a_or1'=0) & (v1'=1) + 0.9: (p1'=1) & (a_or1'=1);
    [] (b_or1=1) & (or1=2) & (c_or1=0) & (p1=0) & (m1=0) -> 0.1: (m1'=1) & (b_or1'=0) & (v1'=1) + 0.9: (p1'=1) & (b_or1'=1) ;
    [] (p1=1) & (a_or1=1) & (c_or1=0) -> (c_or1'=1) & (p1'=1) & (or1'=2) & (v1'=1);
    [] (p1=1) & (b_or1=1) & (c_or1=0) -> (c_or1'=1) & (p1'=1) & (or1'=2) & (v1'=1);
endmodule

module or_gate2
    [] (or2=1) & (a_or2=0) & (b_or2=0) & (c_or2=0) & (m2=0) & (p2=0) -> 0.15: (a_or2'=1) & (or2'=2) + 0.20: (b_or2'=1) & (or2'=2) + 0.65: (or2'=1);
    [] (a_or2=1) & (or2=2) & (c_or2=0) & (p2=0) & (m2=0) -> 0.1: (m2'=1) & (a_or2'=0) & (v2'=1) + 0.9: (p2'=1) & (a_or2'=1);
    [] (b_or2=1) & (or2=2) & (c_or2=0) & (p2=0) & (m2=0) -> 0.1: (m2'=1) & (b_or2'=0) & (v2'=1) + 0.9: (p2'=1) & (b_or2'=1);
    [] (p2=1) & (a_or2=1) & (c_or2=0) -> (c_or2'=1) & (p2'=1) & (or2'=2) & (v2'=1);
    [] (p2=1) & (b_or2=1) & (c_or2=0) -> (c_or2'=1) & (p2'=1) & (or2'=2) & (v2'=1);
endmodule

module or_gate3
    [] (a_or3=1) & (c_or3=0) & (p3=0) & (m3=0) & (v2=1) -> 0.1: (m3'=1) & (a_or3'=0) & (v3'=1) + 0.9: (p3'=1) & (a_or3'=1);
    [] (b_or3=1) & (c_or3=0) & (p3=0) & (m3=0) & (v1=1) -> 0.1: (m3'=1) & (b_or3'=0) & (v3'=1) + 0.9: (p3'=1) & (b_or3'=1);
    [] (p3=1) & (a_or3=1) & (c_or3=0) -> (c_or3'=1) & (p3'=0) & (or3'=2) & (v3'=1);
    [] (p3=1) & (b_or3=1) & (c_or3=0) -> (c_or3'=1) & (p3'=0) & (or3'=2) & (v3'=1);
endmodule
