...
module or_gate1
    [] (or1=1) & (a_or1=0) & (b_or1=0) & (c_or1=0) & (m1=0) & (p1=0) -> 0.2: (a_or1'=1) & (or1'=2) + 0.1: (b_or1'=1) & (or1'=2) + 0.7: (or1'=1);
...
module or_gate2
    [] (or2=1) & (a_or2=0) & (b_or2=0) & (c_or2=0) & (m2=0) & (p2=0) -> 0.2: (a_or2'=1) & (or2'=2) + 0.1: (b_or2'=1) & (or2'=2) + 0.7: (or2'=1);
